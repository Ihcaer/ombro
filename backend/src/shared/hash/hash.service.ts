...
export class HashService {
  ...
  /**
   * Compares hashes generated by {@link HashService.prototype.hash}.
   * @param inputHashed - first hashed value.
   * @param savedHash - second hashed value.
   * @returns Whether the compared hashes are identical.
   */
  ...
  /**
   * Hashes given value by weaker algorithm, like `sha256`.
   * Use this method only to less sensitive data.
